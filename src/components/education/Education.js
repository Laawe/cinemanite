        ...
        <section className={styles['education-wrapper']}>
            <div className={styles['education-title-wrapper']}>
                ...
                <p className={styles['education-paragraph']}>
                    A manera de ejercicio para recordar lo que se vivió al realizar la producción de <Link href={"https://youtu.be/TKBAg116UaQ?si=N0WaJcIHOH3n5M9T"}>Las Cuatro</Link> se escriben las siguientes secciones que te proveerán de los formatos utilizados durante las distintas etapas de nuestro proyecto, así como algunos tips.<br/>
                     De igual forma podrás descargar de manera gratuita estos formatos para que realices tu propio proyecto. <br/><strong>Esta guía no es definitiva, ya que existen formatos utilizados por producciones tradicionales que no serán mencionados.</strong>
                </p>
            </div>
